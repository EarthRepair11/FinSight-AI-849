...
```bash
git clone https://github.com/EarthRepair11/FinSight-AI-849.git
cd FinSight-AI-849
python setup.py
```
...
![CI](https://github.com/EarthRepair11/FinSight-AI-849/actions/workflows/ci.yml/badge.svg)
...
```bash
git clone https://github.com/EarthRepair11/FinSight-AI-849 ~/work/FinSight-AI
cd ~/work/FinSight-AI
...
<!-- Last updated: 2026-06-06 17:03:11 -->
